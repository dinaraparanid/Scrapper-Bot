...
class LinkRepTest {
    @Autowired
    private lateinit var githubSrc: GitHubDataSourceInMemory

    @Autowired
    private lateinit var stackSrc: StackOverflowDataSourceInMemory

    private val linkResponseChannel by lazy {
        Mockito.mock(LinkResponseChannel::class.java)
    }
